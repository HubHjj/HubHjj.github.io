...
void Motor_hou(u16 moa,u16 mob,u16 moc,u16 mod)
{
		...
		TIM_SetCompare1(TIM8,moa+37);	//修改比较值，修改占空比
...
<pre><code>uint8_t guangdian_filine(u8 zt,u8 dir)
{
	if(dir == 1 || dir ==2 )
	{
	//	printf("%u \n",zt);
...
<video src="movie2.mp4"  type="video/mp4" controls="controls"  width="100%" height="100%">
</video>
